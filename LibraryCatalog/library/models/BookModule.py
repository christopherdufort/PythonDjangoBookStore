...
class Book:
    ...
    def store(self):
        ...
        insert_query = "INSERT INTO book (title,author,format,pages,publisher,language,isbn_10,isbn_13,is_loanable)VALUES('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')"%(self.title, self.author, self.book_format, self.pages, self.publisher, self.language, self.isbn_10, self.isbn_13, self.is_loanable)
